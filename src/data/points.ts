...
// on the map read predictably from left to right.
...
// Edges read from the flyer map, then remapped to the new (lng-ordered) IDs.
// Distances are the poster's stated km (road distances along the BIMEP route).
// "dashed" marks the alternate/optional route shown dashed on the flyer.
